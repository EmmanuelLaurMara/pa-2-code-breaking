...
**NAMES:** Emmanuel Laureano and Cullin Kimura
...
```{r}
#| label: create vectors into dataframe
# Create one long vector with all of the symbols, turn it into a dataframe, with one column named "symbols", collects total number symbols in dataframe, create new variable in frame that assigns a number to each symbol
...
```{r}
#| label: Alterate top secrete numbers 
#Add 14 to everyone number in set then multiply by 18 then subtract 257 to exp then square the number.
